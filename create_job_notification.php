...
<head>
    ...
    <title>Create New Job Notification</title>
...
<body>
    <div class="container mt-5">
        ...
        // Notification content - job opportunity notification
        $title = "New Job Opportunities Available";
        $message = "Several new job opportunities have been posted in the IT and Finance sectors. Log in to your dashboard to view and apply for these positions.";
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                <h3 class="my-2">Job Notification Created Successfully</h3>
            </div>
            <div class="card-body">
